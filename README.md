# EBCA dataset
EBCA dataset includes images, ground truth and software for developing camera based 3D vision system for robotic fruit harvesting. The system is based on stereo cameras and a setup with multiple cameras called equal baseline camera array (EBCA). 
